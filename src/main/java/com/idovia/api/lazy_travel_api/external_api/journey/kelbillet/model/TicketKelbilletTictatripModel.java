...
public class TicketKelbilletTictatripModel implements Comparable<TicketKelbilletSncfModel> {
    private int type_id;
    ...
    public TicketKelbilletTictatripModel() {
        
    }

    public TicketKelbilletTictatripModel(int type, String price, String currency, int duration, String departure_date, String arrival_date,
